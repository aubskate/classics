...
const createVimeoLink = (link) => {
    ...
    return `<div class="aubskate-iframe-container"><iframe src="https://player.vimeo.com/video/${videoId}" frameborder="0" allow="autoplay; fullscreen" allowfullscreen class="aubskate-iframe"></iframe></div>`;
};
